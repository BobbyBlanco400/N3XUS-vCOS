...
app.get('/health', (req, res) => {
  res.json({ status: 'healthy', service: 'puabo-dsp-metadata-mgr' });
});

app.get('/', (req, res) => {
  res.json({
    service: 'puabo-dsp-metadata-mgr',
    role: 'DSP Metadata Manager',
...
app.listen(PORT, () => {
  console.log(`✅ puabo-dsp-metadata-mgr listening on port ${PORT}`);
});
