...
app = FastAPI(title="Identity-Registry")
...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "identity-registry"}

@app.get("/")
async def root(): return {"service": "Identity Registry", "phase": "5-6", "role": "Identity Management"}
