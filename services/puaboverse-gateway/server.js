...
app.get('/health', (req, res) => {
  res.json({ status: 'healthy', service: 'puaboverse-gateway' });
});

app.get('/', (req, res) => {
  res.json({
    service: 'puaboverse-gateway',
    role: 'PUABOVERSE Gateway',
...
app.listen(PORT, () => {
  console.log(`✅ puaboverse-gateway listening on port ${PORT}`);
});
