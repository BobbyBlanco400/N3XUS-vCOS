...
app = FastAPI(title="payout-engine")
...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "payout-engine"}

@app.get("/")
async def root(): return {"service": "payout-engine", "phase": "10", "role": "Payout Processing"}
