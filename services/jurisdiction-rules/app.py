...
app = FastAPI(title="jurisdiction-rules")
...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "jurisdiction-rules"}

@app.get("/")
async def root(): return {"service": "jurisdiction-rules", "phase": "Compliance", "role": "Regulatory Compliance"}
