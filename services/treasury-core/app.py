...
app = FastAPI(title="treasury-core")
...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "treasury-core"}

@app.get("/")
async def root(): return {"service": "treasury-core", "phase": "9", "role": "Treasury Management"}
