...
app = FastAPI(title="puabo-dsp-distribution")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "puabo-dsp-distribution"}

@app.get("/")
async def root():
    return {
        "service": "puabo-dsp-distribution",
        "role": "DSP Distribution Engine",
