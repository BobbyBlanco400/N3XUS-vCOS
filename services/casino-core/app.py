...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "casino-core"}

@app.get("/")
async def root(): return {"service": "casino-core", "phase": "7", "role": "Casino Management"}
