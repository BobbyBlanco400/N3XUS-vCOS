...
app.get('/health', (req, res) => {
  res.json({ status: 'healthy', service: 'puabo-blac-creator-hub' });
});

app.get('/', (req, res) => {
  res.json({
    service: 'puabo-blac-creator-hub',
    role: 'BLAC Creator Hub',
...
app.listen(PORT, () => {
  console.log(`✅ puabo-blac-creator-hub listening on port ${PORT}`);
});
