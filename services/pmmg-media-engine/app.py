...
app = FastAPI(title="pmmg-media-engine")
...
@app.get("/health")
async def health(): return {"status": "healthy", "service": "pmmg-media-engine"}

@app.get("/")
async def root(): return {"service": "pmmg-media-engine", "phase": "11", "role": "Media Processing"}
