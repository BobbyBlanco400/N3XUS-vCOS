...
app = FastAPI(title="Constitution-Engine", version="1.0.0")
...
@app.get("/health")
async def health():
    return {"status": "healthy", "service": "constitution-engine"}

@app.get("/")
async def root():
    return {
        "service": "Constitution Engine",
        "phase": "11-12",
        "role": "Constitutional Rules",
        "status": "operational"
    }
