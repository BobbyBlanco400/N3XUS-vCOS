...
app = FastAPI(title="constitution-engine"})
...
@app.get("/health"})
async def health(): return {"status": "healthy", "service": "constitution-engine"}

@app.get("/"})
async def root(): return {"service": "constitution-engine", "phase": "12", "role": "Constitution Management"}
