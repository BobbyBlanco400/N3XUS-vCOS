...
app = FastAPI(title="Attestation-Service"})
...
@app.get("/health"})
async def health(): return {"status": "healthy", "service": "attestation-service"}

@app.get("/"})
async def root(): return {"service": "Attestation Service", "phase": "5-6", "role": "Identity Attestation"}
