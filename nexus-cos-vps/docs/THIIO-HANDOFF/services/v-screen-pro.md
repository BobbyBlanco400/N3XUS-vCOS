...
**Service Name**: v-screen-pro
**Port**: 3074
**Purpose**: Screen production

## Description

Screen and production services
...
- `PORT` - Service port (default: 3074)
...
Access logs via:
```bash
kubectl logs -n <namespace> deployment/v-screen-pro
```
