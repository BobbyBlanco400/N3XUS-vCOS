...
**Service Name**: puabo-dsp-streaming-api
**Port**: 3013
**Purpose**: DSP streaming

## Description

Digital service provider streaming API
...
Access logs via:
```bash
kubectl logs -n <namespace> deployment/puabo-dsp-streaming-api
```
