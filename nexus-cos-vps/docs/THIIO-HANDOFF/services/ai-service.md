...
**Port**: 3031
**Purpose**: General AI capabilities

## Description

Provides core AI and machine learning features
...
- `PORT` - Service port (default: 3031)
...
Access logs via:
```bash
kubectl logs -n <namespace> deployment/ai-service
```
