...
**Service Name**: v-caster-pro
**Port**: 3072
**Purpose**: Professional casting

## Description

Casting service for productions
...
- `PORT` - Service port (default: 3072)
...
Access logs via:
```bash
kubectl logs -n <namespace> deployment/v-caster-pro
```
