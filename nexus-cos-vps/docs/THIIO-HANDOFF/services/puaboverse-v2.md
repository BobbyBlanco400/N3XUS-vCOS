...
**Service Name**: puaboverse-v2
**Port**: 3092
**Purpose**: Metaverse platform

## Description

Virtual world and metaverse platform
...
- `PORT` - Service port (default: 3092)
...
Access logs via:
```bash
kubectl logs -n <namespace> deployment/puaboverse-v2
```
