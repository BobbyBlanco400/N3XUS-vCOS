# puabo-nuki-clothing Module

## Overview

**Module Name**: puabo-nuki-clothing
**Purpose**: NUKI clothing
...
### Installation
```bash
npm install @nexus-cos/puabo-nuki-clothing
```

### Basic Usage
```javascript
import { puabo-nuki-clothing } from '@nexus-cos/puabo-nuki-clothing';

// Initialize module
const module = new puabo-nuki-clothing(config);
...
```bash
cd modules/puabo-nuki-clothing
npm install
npm run dev
```
...
```bash
DEBUG=puabo-nuki-clothing:* npm start
```
