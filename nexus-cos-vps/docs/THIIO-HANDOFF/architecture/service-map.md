...
| Service | Port | Purpose | Dependencies |
|---------|------|---------|--------------|
| puabo_api_ai_hf | 3401 | Core AI | ai-service |
| ai-service | 3031 | General AI | ML models |
| nexus-cos-studio-ai | 3032 | Studio AI | puabo_api_ai_hf |
| puaboai-sdk | 3033 | AI SDK | ai-service |
| puabo-nexus-ai-dispatch | 3034 | AI dispatch | puabo_api_ai_hf, scheduler |
